    ...
    return (
      <div className="relative w-full pb-[5%] [perspective:260px]">
        ...
        >
          ...
          <div className="relative flex h-full items-center justify-center pb-[2%] font-mono text-[clamp(0.5rem,0.85vw,1rem)] font-medium leading-none tabular-nums text-[oklch(0.86_0.15_79)] [text-shadow:0_0_4px_oklch(0.83_0.16_72/72%)]">
            <span>{hh}</span>
